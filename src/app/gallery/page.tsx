			...
			<div className="pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
				...
				<div className="text-center mb-12">
					<span
						...
						{settings.galleryPageBadge ||
							settings.gallerySectionTitle ||
							"Official Gallery"}
					</span>
					...
					<p className="text-slate-400 text-lg max-w-xl mx-auto">
						{settings.galleryPageSubtitle ||
							settings.gallerySectionSubtitle ||
							"Moments from Talamij's various events, workshops, and community activities."}
					</p>
				</div>
				...
				: allPhotos.length === 0 ?
					<div className="flex flex-col items-center justify-center py-24 text-center text-slate-500">
						...
						<p className="text-sm mt-1">
							Admin panel থেকে gallery-তে ছবি upload করুন
						</p>
					</div>
				:	<>
						{/* Category filters */}
